...
class SignUpScreenState extends State<SignUpScreen> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      // Creating the SignUp provider in the tree structure
      create: (_) => SignUpProvider(),
      builder: (context, child) {
        // SafeArea to make the page adaptive to the shape of the phone
        return SafeArea(
          child: Scaffold(
            /*
            ...
            appBar: AppBar(
              ...
              body: Consumer2<SignUpProvider, MainProvider>( // Listening to SignUp and Main providers to access their data
                    ...
                    child: Container(
                      ...
                      child: Column( // Column with text fields for user data, a second access to the login page and a button to confirm user registration
                        ...
                        children: [
                          ...
                          Container(
                              margin: const EdgeInsets.only(bottom: 15),
                              child: TextFieldInfo(textController: signUpProvider.password, label: AppLocalizations.of(context)!.registerLoginSecondLabel, parentContext: context, isNumeric: false,)),
