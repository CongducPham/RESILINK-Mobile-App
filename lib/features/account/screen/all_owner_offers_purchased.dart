              ...
              children: [
                ...
                SizedBox(
                  height: MediaQuery.of(context).size.height * 0.14 *
                      (widget.accountProvider.offerPurchased.isNotEmpty
                          ? widget.accountProvider.offerPurchased.length
                          : 1),
                  child: widget.accountProvider.finishFetchPurchase && !widget.accountProvider.loadingFetchPurchase
                      ? widget.accountProvider.offerPurchased.isNotEmpty
                      ? ListView.builder(
                    ...
                    itemBuilder: (_, int index) {
                      ...
                      : Center(
                    child: Text(
                      AppLocalizations.of(context)!.textNoOfferPurchase,
