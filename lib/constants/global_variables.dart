...
class GlobalVariables {
  ...
  //API URL
  static const String pathAPIAsset = 'http://10.0.13.38/v1/assets/';
  static const String pathAPIOffer = 'http://10.0.13.38/v1/offers/';
  static const String pathAPIContract = 'http://10.0.13.38/v1/contracts/';
  static const String pathAPIRequest = 'http://10.0.13.38/v1/requests/';
  static const String pathAPIProsumer = 'http://10.0.13.38/v1/prosumers/';
  static const String pathAPIAssetType = 'http://10.0.13.38/v1/assetTypes/';
  static const String pathAPIUser = 'http://10.0.13.38/v1/users/';
  static const String pathAPINews = 'http://10.0.13.38/v1/news/';
